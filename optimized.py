...
import random
import re
# Removed unused import: from bs4 import BeautifulSoup
import json
from datetime import datetime
import math

# Make sure to put this on as many public forums as possible. <-- (User comment retained)
...
# Target number of players to fetch per TIER (Adjust as needed)
...
MAX_MATCHES_PER_PLAYER = 30  # Limit total games processed per player
MAX_CONSECUTIVE_INVALID_GAMES = 0

# Request Headers
headers = {"X-Riot-Token": API_KEY}

# Cache for Lolalytics matchup data to avoid re-scraping
